...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `vuelos` (
  `idVuelos` int(11) NOT NULL,
  `idUsuario` int(11) NOT NULL,
  `apSalida` int(11) NOT NULL,
  `apLlegada` int(11) NOT NULL,
  `fSalida` date NOT NULL,
  `fLlegada` date NOT NULL,
  `precio` double NOT NULL,
  `billete` int(11) NOT NULL,
  `vueloscol` varchar(45) NOT NULL,
...
-- Dump completed on 2018-01-29 23:44:30
